...
export class ChartsPage implements AfterViewInit {
  ...
  @ViewChild('halfDoughnutCanvas', { static: true }) halfDoughnutCanvas;
  @ViewChild('lineCanvas', { static: true }) lineCanvas;
  @ViewChild('radarCanvas', { static: true }) radarCanvas;
  @ViewChild('polarCanvas', { static: true }) polarCanvas;
  @ViewChild('pieCanvas', { static: true }) pieCanvas;
  @ViewChild('bubbleCanvas', { static: true }) bubbleCanvas;
  @ViewChild('mixedCanvas', { static: true }) mixedCanvas;
